...
Telegram ID @ShAhZaDa_SoHrAb_420
...
def random_email():
  ...
  os.system('cls' if os.name == 'nt' else 'clear')
  print('''
  [ FACEBOOK CRACKER RANDOM EMAIL ]      creator    shahzada sohrab
...
def pilih():
  print('''
  1. Crack dari nomor random(for facebook hack enter 1)
  2. crack dari email random(for Emails hack enter 2)
  ''')
